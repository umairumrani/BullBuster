...
export default function Footer() {
  ...
  return (
    <footer className='bg-gradient-to-t from-brand-black to-brand-black-soft text-white py-12 sm:py-16'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12'>
          ...
          >
            ...
            <p className='text-gray-400 mb-6'>
              Premium fast food experience in the heart of Lahore, serving
              quality meals with passion and excellence.
            </p>
        ...
        >
          <p className='text-gray-400'>
            &copy; 2024 BullBsuter. All rights reserved. | Privacy Policy |
            Terms of Service
          </p>
        </motion.div>
      </div>
