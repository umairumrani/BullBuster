...
export default function AboutSection() {
  ...
  return (
    <section
      id='about'
      ref={ref}
      className='py-20 bg-gradient-to-br from-brand-black via-brand-black-soft to-brand-black relative overflow-hidden'
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center'>
          ...
          >
            <span className='text-brand-yellow font-semibold text-base sm:text-lg uppercase tracking-wider'>
              Our Story
            </span>
            <h2 className='text-3xl sm:text-4xl lg:text-5xl font-black text-white mt-4 mb-4 sm:mb-6'>
              Crafting Perfection Since Day One
            </h2>
            <p className='text-gray-300 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8'>
              Born in the heart of Lahore, BullBuster represents a revolution in
              fast food excellence. We combine traditional Pakistani hospitality
              with international culinary standards to create an unforgettable
              dining experience.
            </p>
